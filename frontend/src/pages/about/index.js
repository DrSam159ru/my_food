    ...
    <Container>
      ...
      <div className={styles.content}>
        <div>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Представляю вам проект, созданный во время обучения в Яндекс Практикуме. Этот проект — часть учебного курса, но бэкэнд к нему создан самостоятельно.
            </p>
            <p className={styles.textItem}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/DrSam159ru/foodgram" className={styles.textLink}>GitHub</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/DrSam159ru" className={styles.textLink}>Andrew Moshchuk</a>
            </p>
          </div>
        </aside>
      </div>
